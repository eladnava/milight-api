...
public class MilightTimeouts {
    // Amount of time it takes for the bulb to turn on (in millis)
    public static final int TURN_ON_DURATION_MS = 300;

    // Amount of time it takes for the bulb to turn off (in millis)
